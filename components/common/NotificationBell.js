        ...
        <AnimatePresence>
          {unreadCount > 0 && (
            <motion.span
              ...
              exit={{ scale: 0 }}
              transition={springConfig}
              className="absolute -top-0.5 -right-0.5 w-4.5 h-4.5 bg-gradient-to-br from-red-500 to-pink-500 text-white text-[10px] font-bold rounded-full flex items-center justify-center shadow-lg shadow-red-500/30"
                  ...
                  >
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className={`text-sm ${!n.is_read ? 'font-semibold text-gray-900 dark:text-gray-100' : 'text-gray-600 dark:text-gray-400'}`}>
                          {n.message || n.title}
                        </p>
                      ...
                      {!n.is_read && (
                        <motion.span
                          initial={{ scale: 0 }}
                          animate={{ scale: 1 }}
                          className="w-2 h-2 bg-blue-500 rounded-full shrink-0 mt-2"
                        />
                      )}
                    </div>
                  </Link>
